...
App.LinksPanel = Ext.extend(Ext.Container,
 ...
 // afterRender: function() {
      //App.LinksPanel.superclass.afterRender.apply(this, arguments);
      //Ext.ux.Lightbox.registerUrl("a.examplelink", 900, 600);
   // }
  }
);
...
App.SideBar = Ext.extend(Ext.Container,
  ...
  Selections: {
    ...
    links:[
        ...
        text: 'Location/City',
        id: 'link-1',
        //href: 'http://docs.google.com/viewer?url=http://sites.google.com/site/actuarybrad/pdfs/home.pdf?&embedded=true'
        href: '#'
        }, {
        text: 'Deductible',
        id: 'link-2',
  ...
  afterRender: function() {
    ...
    this.el.on('mousedown', this.doAction, this, {delegate: 'li.bullet'});
    this.el.on('mouseover', this.mouseOver, this.el.dom, {delegate: 'li.bullet'});
    this.el.on('mouseout', this.mouseOut, this.el.dom, {delegate: 'li.bullet'});
  },
  onLayout: function() {
    Ext.get('link-0').addClass('bulletClick');
    //console.log(Ext.get('link-0'));
  },
