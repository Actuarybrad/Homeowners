...
App.StartPage = Ext.extend(Ext.BoxComponent, {
	pageContent:[
		...
		'<p>This comparison guide is provided to assist you in shopping for workers compensation insurance in New Mexico. Using the links on the left, you will be presented with the loss cost multiplier approved for each insurance carrier in New Mexico.</p><p><img width="50" height="50" src="images/zia.jpg" class="right" /></p>',
		...
		'<p>To learn more about Workers Compensation Insurance, please visit the links listed under <span class="highLight">"Workers Compensation Links"</span>.</p>',
    ...
    '<div id="prcLogo"><a href="http://www.nmprc.state.nm.us/index.htm"><img width="225px" height="40px" src="images/prc.jpg" alt="" /></a></div>',
		'</div>'	
	],
  id: 'card-10',
...
Ext.reg('startpage', App.StartPage);